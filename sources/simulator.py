...
class PhysicsSimulator:
    ...
    def _handle_mouse_down(self, event):
        ...
        # Check button clicks
        if pygame.Rect(40, HEIGHT - 22, 180, 40).collidepoint(event.pos):
            self.ui.conversor_visible = not self.ui.conversor_visible
        elif pygame.Rect(240, HEIGHT - 22, 180, 40).collidepoint(event.pos):
            self._toggle_graph()
        elif pygame.Rect(440, HEIGHT - 22, 180, 40).collidepoint(event.pos):
