...
class GraphicsManager:
    ...
    def draw_rope(self, screen, start, end):
        ...
        polea_rect = self.polea_image.get_rect(center=(350,190))
        screen.blit(self.polea_image, polea_rect)
        
        polea_rect2 = self.polea_image.get_rect(center=(1000,190))
        screen.blit(self.polea_image, polea_rect2)

    def draw_weight(self, screen, x, y):
        """Draw weight image at specified position."""
        peso_rect = self.peso_image.get_rect(center=(x, y))
